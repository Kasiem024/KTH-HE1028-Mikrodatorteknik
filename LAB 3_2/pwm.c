...
void T1setPWMmotorB(int throttle)
{
    if (throttle > 0)
    {
        timer_channel_output_pulse_value_config(TIMER1, TIMER_CH_2, (throttle / 100.0) * 16000);
        timer_channel_output_pulse_value_config(TIMER1, TIMER_CH_3, 0);
    }
    else
    {
        timer_channel_output_pulse_value_config(TIMER1, TIMER_CH_2, 0);
        timer_channel_output_pulse_value_config(TIMER1, TIMER_CH_3, (-throttle / 100.0) * 16000);
    }
}
